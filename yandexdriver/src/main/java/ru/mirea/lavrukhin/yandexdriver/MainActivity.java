package ru.mirea.lavrukhin.yandexdriver;
...
import ru.mirea.lavrukhin.yandexdriver.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener{
    ...
    private final Point ROUTE_START_LOCATION = new Point(55.7935, 37.7012);
    private final Point ROUTE_END_LOCATION = new Point(55.7519, 37.6177);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitRequest();
        PlacemarkMapObject marker = mapView.getMap().getMapObjects().addPlacemark(new Point(55.7519, 37.6177));
        marker.addTapListener(new MapObjectTapListener() {
            @Override
            public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point
                    point) {
                Toast.makeText(getApplication(),"КРЕМЛЬ",
